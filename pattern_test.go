...
func TestJsonPattern(t *testing.T) {
	...
	p4 := NewPattern("{\"level\":\"error\",\"ts\":\"2025-04-09T11:10:07Z\",\"logger\":\"manager\",\"msg\":\"Reconciler error\",\"controller\":\"vmalertmanagerconfig\",\"controllerGroup\":\"operator.victoriametrics.com\",\"controllerKind\":\"VMAlertmanagerConfig\",\"VMAlertmanagerConfig\":{\"name\":\"iteration-test-106-alert-config\",\"namespace\":\"iteration-test-106\"},\"namespace\":\"iteration-test-106\",\"name\":\"iteration-test-106-alert-config\",\"reconcileID\":\"8c03f096-3818-414b-8b72-ab34f979caf9\",\"error\":\"get_object error for controller=\\\"vmalertmanagerconfig\\\" object_name=\\\"iteration-test-106-alert-config\\\" at namespace=\\\"iteration-test-106\\\", origin=\\\"VMAlertmanagerConfig.operator.victoriametrics.com \\\\\\\"iteration-test-106-alert-config\\\\\\\" not found\\\"\",\"stacktrace\":\"sigs.k8s.io/controller-runtime/pkg/internal/controller.(*Controller).reconcileHandler\\n\\tsigs.k8s.io/controller-runtime@v0.17.2/pkg/internal/controller/controller.go:329\\nsigs.k8s.io/controller-runtime/pkg/internal/controller.(*Controller).processNextWorkItem\\n\\tsigs.k8s.io/controller-runtime@v0.17.2/pkg/internal/controller/controller.go:266\\nsigs.k8s.io/controller-runtime/pkg/internal/controller.(*Controller).Start.func2.2\\n\\tsigs.k8s.io/controller-runtime@v0.17.2/pkg/internal/controller/controller.go:227\"}")

	assert.NotEqual(t, "d4c3b7e0f4a1d2c5e8f9a4b5d6e7f8a9", p4.Hash())

	p5 := NewPattern("{\"level\":\"error\",\"ts\":\"2025-04-09T11:10:07Z\",\"logger\":\"manager\",\"msg\":\"Reconciler error\",\"controller\":\"vmalertmanagerconfig\",\"controllerGroup\":\"operator.victoriametrics.com\",\"controllerKind\":\"VMAlertmanagerConfig\",\"VMAlertmanagerConfig\":{\"name\":\"iteration-test-106-alert-config\",\"namespace\":\"iteration-test-106\"},\"namespace\":\"iteration-test-106\",\"name\":\"iteration-test-106-alert-config\",\"reconcileID\":\"8c03f096-3818-414b-8b72-ab34f979caf9\",\"error\":\"get_object error for controller=\\\"vmalertmanagerconfig\\\" object_name=\\\"iteration-test-106-alert-config\\\" at namespace=\\\"iteration-test-106\\\", origin=\\\"VMAlertmanagerConfig.operator.victoriametrics.com \\\\\\\"iteration-test-106-alert-config\\\\\\\" not found\\\"\",\"stacktrace\":\"sigs.k8s.io/controller-runtime/pkg/internal/controller.(*Controller).reconcileHandler\\n\\tsigs.k8s.io/controller-runtime@v0.17.2/pkg/internal/controller/controller.go:329\\nsigs.k8s.io/controller-runtime/pkg/internal/controller.(*Controller).processNextWorkItem\\n\\tsigs.k8s.io/controller-runtime@v0.17.2/pkg/internal/controller/controller.go:266\\nsigs.k8s.io/controller-runtime/pkg/internal/controller.(*Controller).Start.func2.2\\n\\tsigs.k8s.io/controller-runtime@v0.17.2/pkg/internal/controller/controller.go:227\"}")
	assert.Equal(t, p4.String(), p5.String())
	assert.Equal(t, p4.Hash(), p5.Hash())
}
